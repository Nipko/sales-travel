...
const COUNTRY_NAME_ES: Record<string, string> = {
  ...
  BB: 'Barbados', BD: 'Bangladesh', BE: 'Bélgica', BF: 'Burkina Faso', BG: 'Bulgaria',
  BH: 'Bahréin', BI: 'Burundi', BJ: 'Benín', BM: 'Bermudas', BN: 'Brunéi',
  BO: 'Bolivia', BR: 'Brasil', BS: 'Bahamas', BT: 'Bután', BW: 'Botsuana',
  BY: 'Bielorrusia', BZ: 'Belice', CA: 'Canadá', CD: 'Congo RDC', CF: 'Rep. Centroafricana',
  CG: 'Congo', CH: 'Suiza', CI: 'Costa de Marfil', CL: 'Chile', CM: 'Camerún',
  CN: 'China', CO: 'Colombia', CR: 'Costa Rica', CU: 'Cuba', CV: 'Cabo Verde',
  CW: 'Curaçao', CY: 'Chipre', CZ: 'Chequia', DE: 'Alemania', DJ: 'Yibuti',
  DK: 'Dinamarca', DM: 'Dominica', DO: 'Rep. Dominicana', DZ: 'Argelia', EC: 'Ecuador',
  EE: 'Estonia', EG: 'Egipto', ER: 'Eritrea', ES: 'España', ET: 'Etiopía',
  FI: 'Finlandia', FJ: 'Fiyi', FK: 'Malvinas', FM: 'Micronesia', FO: 'Islas Feroe',
  FR: 'Francia', GA: 'Gabón', GB: 'Reino Unido', GD: 'Granada', GE: 'Georgia',
  GF: 'Guayana Francesa', GH: 'Ghana', GI: 'Gibraltar', GL: 'Groenlandia', GM: 'Gambia',
  GN: 'Guinea', GP: 'Guadalupe', GQ: 'Guinea Ecuatorial', GR: 'Grecia', GT: 'Guatemala',
  GU: 'Guam', GW: 'Guinea-Bisáu', GY: 'Guyana', HK: 'Hong Kong', HN: 'Honduras',
  HR: 'Croacia', HT: 'Haití', HU: 'Hungría', ID: 'Indonesia', IE: 'Irlanda',
  IL: 'Israel', IN: 'India', IQ: 'Irak', IR: 'Irán', IS: 'Islandia', IT: 'Italia',
  ...
  ME: 'Montenegro', MG: 'Madagascar', MH: 'Islas Marshall', MK: 'Macedonia del Norte',
  ML: 'Mali', MM: 'Myanmar', MN: 'Mongolia', MO: 'Macao', MQ: 'Martinica',
  ...
  PK: 'Pakistán', PL: 'Polonia', PR: 'Puerto Rico', PS: 'Palestina', PT: 'Portugal',
  PW: 'Palaos', PY: 'Paraguay', QA: 'Catar', RE: 'Reunión', RO: 'Rumanía',
  ...
  SR: 'Surinam', SS: 'Sudán del Sur', SV: 'El Salvador', SX: 'San Martín', SY: 'Siria',
  ...
  UZ: 'Uzbekistán', VA: 'Vaticano', VC: 'San Vicente y las Granadinas', VE: 'Venezuela',
